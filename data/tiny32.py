...
parser.add_argument('--i', default='raw/tiny32.pt', help='input directory')
parser.add_argument('--o', default='tiny32.pt', help='output file')
parser.add_argument('--n_tasks', default=40, type=int, help='number of tasks')
