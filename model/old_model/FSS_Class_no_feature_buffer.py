...
# we can improve the efficiency of this method.
# first to test the effectiveness
...
class Net(nn.Module):
    ...
    def select_k_centers_each_class(self,class_id,class_data,class_labs,class_features,pretrained,beta=2,alpha=1):
        ...
        if class_id not in self.sampled_class_labs.keys():
            ...
            samples_mem_features=class_features[0].unsqueeze(0) 
        else:
            ...
            if pretrained==None:
                samples_mem_features = self.net.feature_extractor(sampled_memory_data).data
            else:
                samples_mem_features = pretrained.feature_extractor(sampled_memory_data).data
    ...
    def select_k_centers(self,pretrained):
        ...
        for class_id in range(start_index,end_index):
            ...
            self.select_k_centers_each_class(class_id,class_data,class_labs,class_features,pretrained)
